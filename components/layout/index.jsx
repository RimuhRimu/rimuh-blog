...
import { Discord, GitHub, HalfMoon, SunLight, Twitter } from 'iconoir-react'
			...
			<main className={styles.app}>
				...
				<div className={styles.icons}>
					...
					<div className={styles.topSocialMedia}>
						<a href='https://github.com/RimuhRimu' target='_blank'>
							<GitHub className={styles.github} />
						</a>
						<a href='https://twitter.com/rimuhrimu' target='_blank'>
